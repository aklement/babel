...
public abstract class ProbDictScorer extends Scorer
{
  protected static final Log LOG = LogFactory.getLog(ProbDictScorer.class);

  public ProbDictScorer(ProbabilisticDictionary dict)
  {
    m_dict = dict;
  }
  ...
  // Preparing a particular EQ item, context is its contexts over all tokens
  public void prepare(EquivalenceClass eq)
  {
    ...
    // Here, project probabilistically
  ...
  protected ProbabilisticDictionary m_dict;
}
